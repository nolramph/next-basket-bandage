const Book = ({ color = '#23A6F0' }: { color?: string } = {}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
      <path d="M42.75 22.5H58.5V27H42.75V22.5Z" fill={color} />
      <path d="M42.75 33.75H58.5V38.25H42.75V33.75Z" fill={color} />
      <path d="M42.75 45H58.5V49.5H42.75V45Z" fill={color} />
      <path d="M13.5 22.5H29.25V27H13.5V22.5Z" fill={color} />
      <path d="M13.5 33.75H29.25V38.25H13.5V33.75Z" fill={color} />
      <path d="M13.5 45H29.25V49.5H13.5V45Z" fill={color} />
      <path
